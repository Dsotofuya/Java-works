...
public class Resident implements Serializable {
	...
	public String toString() {
		return "Resident [resident_id=" + resident_id + ", resident_name=" + resident_name + ", resident_last_name="
				+ resident_last_name + ", resident_phone_number=" + resident_phone_number + ", accountStateType="
				+ accountStateType + ", realStates=" + realStates + "]";
	}
}
