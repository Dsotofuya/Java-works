...
//	private static final String HOST = "192.168.1.8";
	...
	public void addPost(String tittle, byte[] image, String description, int phone) throws UnknownHostException, IOException {
	...
	public void contact(String message, int id) throws UnknownHostException, IOException {
		Socket socket = new Socket(HOST, 2323);
		DataOutputStream output = new DataOutputStream(socket.getOutputStream());
