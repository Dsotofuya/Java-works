...
public class PostPanel extends JPanel {
	...
	public PostPanel(ActionListener control) {
		...
		contact.setActionCommand(Events.CONTACT.toString());
		contact.addActionListener(control);
	...
	public void fillPost(int id, String tittle, String photoPhat, String description, int phone) {
		this.id = id;
