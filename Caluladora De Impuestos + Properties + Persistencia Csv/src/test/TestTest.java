...
class TestTest {
	...
	@Before
	public ArrayList<Brand> setup() throws Exception {
	...
	void test() throws Exception {
		VehicleTax v = new VehicleTax(setup());
		double expected =  748800.0;
		double actual =  v.calculateTax("animalitos", "perrito", 2011, 
				true, false, true);
