 ...
 */
@WebServlet("/SelectFindPersonaServlet")
public class SelectFindPersonaServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
    private PersonaManager pm;   
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SelectFindPersonaServlet() {
        super();
	...
	private void listPersona(HttpServletRequest request, HttpServletResponse response)
		...
		pm = new PersonaManager();
	 	...
	 	RequestDispatcher dispatcher = request.getRequestDispatcher("selFindPerson.jsp");
