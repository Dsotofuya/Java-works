 ...
 */
@WebServlet("/SelectDelPersonaServlet")
public class SelectDelPersonaServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
    private PersonaManager pm;   
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SelectDelPersonaServlet() {
        super();
	...
	private void listPersona(HttpServletRequest request, HttpServletResponse response)
		...
		pm = new PersonaManager();
	 	...
	 	RequestDispatcher dispatcher = request.getRequestDispatcher("selDelPerson.jsp");
