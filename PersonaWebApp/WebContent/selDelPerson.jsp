...
<body>
<h1> PERSON APP</h1>
 <h2> Hola, por favor seleccione la persona a eliminar</h2>
 <form action="DeletePersonaServlet" method="post">
 <table cellspacing="3" cellpadding="3" border="1" >
 <tr>
 <td align="right"> Seleccione el documento de la persona a eliminar</td>
 </tr>
 <tr>
 <td> 
