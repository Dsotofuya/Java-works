...
public class FooterPanel extends JPanel{
	...
	public FooterPanel() {
		cloud = new JButton(new ImageIcon("src/zData/cloudIcon.png"));
		cloud.setFocusable(false);
		cloud.setBackground(Color.decode("#D90007"));
		cloud.setBorder(BorderFactory.createEmptyBorder());
		add(cloud);
		uploadCamera = new JButton(new ImageIcon("src/zData/cloudIcon.png"));
		...
		add(uploadCamera);
		chat = new JButton(new ImageIcon("src/zData/messagesIcon.png"));
		chat.setBackground(Color.decode("#D90007"));
		chat.setFocusable(false);
		chat.setBorder(BorderFactory.createEmptyBorder());
		add(chat);
		sharedFolders = new JButton(new ImageIcon("src/zData/cloudIcon.png"));
		...
		add(sharedFolders);
		withoutConexion = new JButton(new ImageIcon("src/zData/downLoadIcon.png"));
