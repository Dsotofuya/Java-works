...
//		}
		brand_txt.setModel(new DefaultComboBoxModel<Object>(brandList));
	}
...
//		}
		line_txt.setModel(new DefaultComboBoxModel<Object>(lineList));
	}
	
	public void writeJCBModel(Object[] modelList) {
		model_txt.removeAllItems();
//		for (Object object : modelList) {
			model_txt.setModel(new DefaultComboBoxModel<Object>(modelList));
//		}
	}
	...
	public int modelSelected() {
		return (int) model_txt.getSelectedItem();
	}
	public void clean(){
