...
public class CardsPanel extends JPanel {
	...
	/**
	 * Constructor of the center side of the frame, this generate cards for the
	 * songs returned from the server
	 **/
...
//				BufferedImage image = ImageIO.read(con.getInputStream());
			JLabel card = new JLabel(song.getName(), new ImageIcon(new ImageIcon(/* image */new URL(song.getUrlImage()))
					.getImage().getScaledInstance(50, 50, Image.SCALE_SMOOTH)), SwingConstants.LEADING);
